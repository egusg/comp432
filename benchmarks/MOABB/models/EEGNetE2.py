...
class ResidualBlock(torch.nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=(3, 1), stride=1, padding="same"):
        ...
        self.bn1 = sb.nnet.normalization.BatchNorm2d(
            input_size=out_channels, momentum=0.01, affine=True,
        )
        ...
        self.bn2 = sb.nnet.normalization.BatchNorm2d(
            input_size=out_channels, momentum=0.01, affine=True,
        )
...
class EEGNet(torch.nn.Module):
    ...
    new_out_channels: int
        Number of output channels for the newly added convolutional layer. Example: 16
    new_kernel_size: tuple
        Kernel size for the newly added convolutional layer. Example: (3, 1)
